    ...
    implements ActionListener, KeyListener, ItemListener, TextListener, MouseListener
{
    ...
    /**
     * Looks through the list of options and returns the value of the load board option (key=LB)
     */
    private boolean getLoadBoardOption(){
    	Object[] optArr =  new TreeSet(opts.values()).toArray();
    	SOCGameOption op;
    	for (int i = 0; i < optArr.length; ++i)
        {
    ...
    /**
     * Looks through the list of options and returns the value of the chat negotiations option (key=CN)
     */
    private boolean getChatNegotiationsOption(){
    	Object[] optArr =  new TreeSet(opts.values()).toArray();
    	SOCGameOption op;
    	for (int i = 0; i < optArr.length; ++i)
        {
    ...
    /**
     * Looks through the list of options and returns the value of the chat negotiations option (key=FO)
     */
    private boolean getFullyObservableOption(){
    	Object[] optArr =  new TreeSet(opts.values()).toArray();
    	SOCGameOption op;
    	for (int i = 0; i < optArr.length; ++i)
        {
