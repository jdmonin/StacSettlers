...
//    	     e.printStackTrace();
    ...
    protected SOCPlayerInterface getPlayerInterface(String gaName, SOCGame ga, final int[] layoutVS, final Map<String, Object> localPrefs) {
    	return new SOCPlayerInterface(gaName, mainDisplay, ga, layoutVS, localPrefs);
    }
    ...
    public static void main(String[] args)
    {
        ...
        Version.printVersionText(System.out, "Java StacSettlers Client (based on JSettlers Client version 2.4.50) ");
...
//            return;
        ...
        JFrame frame = new JFrame("STACSettlers client (based on JSettlers 2.4.50)");
