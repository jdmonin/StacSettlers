...
public class SOCBuildingPanel extends Panel implements ActionListener
{
     ...
     * @since 1.1.08
     */
    public static final int MINHEIGHT =  2 + (4*ColorSquare.HEIGHT) + (3*ColorSquare.HEIGHT / 2) + 32;
...
//        cardOre.setLocation(curX, curY);
    ...
    /**
     * Update the player object reference
     * 
     * @param pl the new player object 
     */
    public void resetPlayer(SOCPlayer pl){
    	player = pl;
    }
