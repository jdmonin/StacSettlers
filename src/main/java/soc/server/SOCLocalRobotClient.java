...
/*package*/ class SOCLocalRobotClient implements Runnable
{
    ...
    public static Thread createAndStartRobotClientThread
        (SOCRobotFactory factory, final String rname, final ServerConnectInfo sci, final SOCGameOptionSet knownOpts,
         final Constructor<? extends SOCRobotClient> cliConstruc3p, SimpleAgent deeptrader)
        throws ClassNotFoundException, IllegalArgumentException, LinkageError, ReflectiveOperationException
    {
        final SOCRobotClient rcli =
            (cliConstruc3p == null)
            ? new SOCRobotClient(factory, sci, rname, "pw", deeptrader)
