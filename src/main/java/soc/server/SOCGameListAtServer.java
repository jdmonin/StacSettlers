...
public class SOCGameListAtServer extends SOCGameList
{
    ...
    public synchronized void addMember(StringConnection conn, String gaName)
    {
        ...
        if ((members != null) && (!members.contains(conn)))
        {
            D.ebugPrintlnINFO("L139: game " + gaName + " add " + conn);  // JM TEMP
    ...
    {
        D.ebugPrintlnINFO("L139: game " + gaName + " remove " + conn);  // JM TEMP
        Vector members = getMembers(gaName);
        ...
        throws IllegalArgumentException
    {
        ...
        D.ebugPrintlnINFO("L212: replaceMemberAllGames(" + oldConn + ", " + newConn + ")");  // JM TEMP
        ...
        while (allGa.hasMoreElements())
        {
            ...
            {
                D.ebugPrintlnINFO("L221: for game " + gaName + ":");  // JM TEMP
                if (sameVersion)
                {
    ...
    public SOCGameBoardReset resetBoard(String gaName)
    {
        ...
        {
            D.ebugFATAL(e, "ERROR -> gamelist.resetBoard");
        }
        finally
        {
